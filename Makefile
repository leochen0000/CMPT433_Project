...
miniGamesConsole:
	...
	@echo " "
	$(CC_C) $(CFLAGS) miniGamesConsole.c bbg_led.c ext_photoresistor.c ext_buttons.c zen_joystick.c zen_accelerometer.c zen_segdisplay.c zen_potentiometer.c -pthread -o $(OUTDIR)/$(OUTFILE1)
	@echo " "
